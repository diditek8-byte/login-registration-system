...
form.addEventListener('submit', (e) => {
  ...
  if(name_input) {
    errors = getRegistrationFormErrors(name_input.value, email_input.value, repeat_password_input.value, repeat_password_input.value)
  }
  else {
...
function getRegistrationFormErrors(name, email, password, repeatPassword){
    let errors =[]
    ...
    if(password.length < 8) {
        errors.push('Password must at least have 8 characters')
        password_input.parentElement.classList.add('incorrect')
    }
